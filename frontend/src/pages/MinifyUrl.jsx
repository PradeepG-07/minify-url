        ...
        <div className="min-h-[84vh] items-center justify-center flex flex-col gap-2 md:gap-7 pt-3">
            <form action="#" name="minifyUrlForm" onSubmit={handleSubmit} className="w-full">
                <div className="flex flex-col gap-2 md:gap-7 justify-center">
                    <h1 className="text-5xl font-bold text-gray-800 text-center">Get Your Short Url Here</h1>
                    ...
                    <input type="text" name="longUrl" id="longUrl" className="w-full md:w-1/2 mx-auto px-4 text-xl py-2 rounded bg-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-600" placeholder="Enter your long URL" required />
                    <button type="submit" className="w-fit mx-auto px-4 text-xl py-2 rounded bg-amber-600 hover:bg-amber-700 transition-all text-white" disabled={isGeneratingUrl ? true : false}>
                        {isGeneratingUrl ? "Generating..." : "Generate Short URL"}
                    </button>
                </div>
            </form>
            <div className="flex flex-col gap-4 items-center min-h-20">
                <a className="text-xl" id="miniURL"></a>
